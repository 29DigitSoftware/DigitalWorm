      ...
      <div class="setting-wrapper" v-show="isSettingShow">
        ...
        <div class="setting-progress" v-show="showTag == 2">
          ...
          <div class="text-wrapper">
            <span>{{ isBookAvailable ? progress + '%' : 'Загрука...'}}</span>
          </div>
        </div>
      </div>
    </transition>
  ...
  export default {
    ...
    methods: {
      ...
      onProgressChange: function (e) {
        console.log("you re in right way")
...
<style lang="scss" scoped>
  ...
  .menu-bar {
    .menu-wrapper {
      ...
      width: 100%;
      height: px2rem(300);
      box-shadow: 0 px2rem(-45) px2rem(45) rgba(0, 0, 0, .15);
      background: #fff;
      &.hide-box-shadow {
        box-shadow: none;
      }
        ...
        .font-wrapper {
          ...
          .font-size {
            ...
            .point {
              ...
              box-shadow: 0 px2rem(24) px2rem(24) rgba(0, 0, 0, .15);
        ...
        .progress-wrapper {
          ...
          .progress {
            ...
            &::-webkit-slider-thumb {
              ...
              height: px2rem(120);
              border-radius: 50%;
              box-shadow: 0 px2rem(24) px2rem(24) 0 rgba(0, 0, 0, .15);
